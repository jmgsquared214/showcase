...
public class HBRelationOneToMany extends ShowcasePanel {
    ...
    private static final String DESCRIPTION = "Smart GWT handles Hibernate One-to-Many relations transparently (such as a Country which has " +
            "multiple Cities).  Simply declare a collection field (<code>multiple:true</code>) on the \"countryManyToOneSimpleHB\" " +
            "DataSource to indicate its list of Cities also needs to be loaded." +
            "<P>" +
            ...
            "request, and Smart GWT automatically makes all the required Hibernate calls to persist the " +
