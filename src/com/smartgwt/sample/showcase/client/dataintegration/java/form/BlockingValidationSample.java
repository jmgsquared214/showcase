...
public class BlockingValidationSample extends ShowcasePanel {
    private static final String DESCRIPTION = 
        ...
        "number must reference an existing number, so use 4110884 or 9631143 as existing numbers. "+
        "Then try again with a random number (such as 1234). Note that when an "+
        "invalid value is entered, focus is not allowed to move forward. "+
        "<P/>"+
