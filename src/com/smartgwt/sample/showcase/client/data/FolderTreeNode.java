...
public class FolderTreeNode extends ExplorerTreeNode {
    ...
    public FolderTreeNode(String name, String nodeID, String parentNodeID, String icon, 
                          boolean enabled, String idSuffix, boolean isOpen) {
        super(name, nodeID, parentNodeID, icon, null, enabled, true, idSuffix, isOpen);
    }
    
    public FolderTreeNode(String name, String nodeID, String parentNodeID, String icon, 
                          boolean enabled, String idSuffix, boolean isOpen, String version) {
        super(name, nodeID, parentNodeID, icon, null, enabled, true, idSuffix, isOpen, version);
    }
