...
public class IntroductionPanel extends ShowcasePanel {
    private static final String DESCRIPTION = "A brief introduction to " + Showcase.getSGWTProductName() + ".";
    ...
    public Canvas getViewPanel() {
        ...
        pane.setHeight100();
        pane.setPadding(10);
        pane.setContentsURL("doc/introduction.html");
